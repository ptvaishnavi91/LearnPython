...
class File_Input():
    def __init__(self):
        ...
        self.input_choice = input('How do you want to enter the news feed? 1. Through console, 2. Using input text file\n')

    def file_input_func(self):
        # Task 2: Default folder or user provided file path
        ip_file_path = input('Enter the path of the input file:\n')
        # Use input file C:\Users\Vaishnavi_Peranamall\PycharmProjects\LearnPython\ModuleFiles\News_input.txt to test the file removal,
        # use C:\Users\Vaishnavi_Peranamall\PycharmProjects\LearnPython\ModuleFiles\News_input_test_normalize.txt to test case normalization of the input text
